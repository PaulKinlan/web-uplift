...
async function main() {
  ...
  if (!primitive || !url) {
    console.error(
      'Usage: node evidence/cli.mjs <screenshot|video|heap|layout|dom|evaluate|trace|har|discoverability|targets|secrets|headers|cookies|trackers|images> <url> [options]\n' +
