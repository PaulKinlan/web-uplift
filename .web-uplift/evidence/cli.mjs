...
async function main() {
  ...
  if (!primitive || !url) {
    console.error(
      'Usage: node evidence/cli.mjs <screenshot|video|heap|layout|dom|evaluate|axe|a11ytree|trace|har|discoverability|console|targets|features|secrets|headers|cookies|trackers|images> <url> [options]\n' +
