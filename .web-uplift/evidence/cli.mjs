...
async function main() {
  ...
  if (!primitive || !url) {
    console.error(
      'Usage: node evidence/cli.mjs <screenshot|video|heap|layout|dom|evaluate|trace|har|discoverability|console|features|secrets|headers|cookies|trackers|images> <url> [options]\n' +
